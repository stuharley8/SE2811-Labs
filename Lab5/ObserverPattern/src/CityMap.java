...
public class CityMap extends Application {
    ...
    private static Image backgroundImage = new Image(CityMap.class.getResource("img/map.png")
            .toString());
    private static Image painting = new Image(CityMap.class
            .getResource("img/wood-gatherer.png").toString());
    ...
    private ChallengesSubject challengesSubject = new ChallengesSubject();
    ...
    public void taggedBy(MobileEntity entity) {
        for(Taggable taggable: taggables) {
            if(taggable.isTagged(entity.getLocation())) {
                ...
                challengesSubject.changeState(taggable, entity, challengePane);
            }
        }
    }
    ...
    private void addEntities() {
        ...
        challengesSubject.attach(new WordObserver("MSOE"));
        challengesSubject.attach(new MuseumObserver(painting));
        challengesSubject.attach(new HiddenWordObserver("BUS"));
    }
}